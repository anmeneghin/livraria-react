        ...
        <>
            ...
            <div className="home">
                <div className="row">
                    ...
                    <br />
                    <h3 className='icons-social-media'>
                        <a target="_blank" href='https://www.instagram.com/anmeneghin/' rel="noreferrer"><FaInstagram></FaInstagram>&nbsp;</a>
                        <a target="_blank" href='https://www.linkedin.com/in/anmeneghin/' rel="noreferrer"><FaLinkedin></FaLinkedin>&nbsp;</a>
                        <a target="_blank" href='https://github.com/anmeneghin/' rel="noreferrer"><FaGithub></FaGithub></a>
                    </h3>
                </div>
